...
export class BrandService {
    ...
    getBrands(pageSize: number, pageNumber: number): Observable<any> {
      return this.http.get<any>(`${this.url}/api/brand/get-all?pageSize=${pageSize}&pageNumber=${pageNumber}`);
    }
    createBrand(data: any): Observable<any> {
      return this.http.post<any>(`${this.url}/api/brand/create`, data)
        .pipe(
    ...
    CheckBrandExistence(name: string): Observable<boolean> {
      return this.http.get<boolean>(`${this.url}/api/brand/CheckExistence?name=${name}`);
    }
    ...
    checkBrandExistenceUpdate(name: string, id: number): Observable<boolean> {
      return this.http.get<boolean>(`${this.url}/api/brand/CheckExistenceUpdate?name=${name}&id=${id}`);
    }
    ...
    getAllBrands(): Observable<Brand[]> {
      return this.http.get<Brand[]>(`${this.url}/api/brand/getallbrandpro`);
    }
    searchBrands(pageSize: number, pageNumber: number, keySearch: string): Observable<any> {
